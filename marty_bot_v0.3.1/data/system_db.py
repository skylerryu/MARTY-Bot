...
async def init_system_db():
    ...
    async with aiosqlite.connect(
        ...
        # ==================================================
        # ACTIVE SPEED QUESTION
        # ==================================================
        #
        # One row per guild/channel.
        #
        # Posting a new RSQ overwrites this row,
        # which retires the previous RSQ from
        # answer processing.
        #
        # ==================================================
        ...
        await _ensure_column(
            db=db,
            table_name="active_speed_questions",
        ...
        # ==================================================
        #
        # One record for each generated daily schedule.
        #
        # ==================================================
        ...
        await db.execute(
            """
            CREATE TABLE IF NOT EXISTS rsq_schedule_days (
                guild_id INTEGER NOT NULL,
                channel_id INTEGER NOT NULL,
        ...
        await db.execute(
            """
            CREATE TABLE IF NOT EXISTS rsq_schedule_slots (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        await db.execute(
            """
            CREATE INDEX IF NOT EXISTS
            idx_rsq_schedule_slots_pending

            ON rsq_schedule_slots (
                guild_id,
                channel_id,
                status,
                scheduled_at
        ...
        # ==================================================
        #
        # Records every RSQ actually posted,
        # automatic or manual.
        #
        # Used for:
        #
        ...
        await db.execute(
            """
            CREATE TABLE IF NOT EXISTS rsq_post_history (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
